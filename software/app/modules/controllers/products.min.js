...
singgleProduct.$inject = ['$rootScope', '$scope', 'services', 'Products', '$stateParams'];
function singgleProduct($rs, $s, svc, Products, $sp){
	svc.mainMenu(function(m){
		$rs.menu = m;
	});
	Products.getProduct($sp.id, {}, function(e, r){
		console.log(r.data);
		$s.product = r.data;
	});
